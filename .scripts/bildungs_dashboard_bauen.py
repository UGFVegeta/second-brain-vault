...
PHYSIK = [
    ...
    {"klasse": "10", "untertitel": "Kernphysik", "themen": [
        {"titel": "Kernphysik", "stunden": [
            {"id": "ph10-kern", "titel": "Kernphysik (Struktur der Materie, Leitfragen 1–6)", "wann": "", "status": "geplant",
             "links": [f("Folien", PH + "Kernphysik/Kernphysik.html"), f("PDF", PH + "Kernphysik/Kernphysik.pdf")]},
        ], "material": [
