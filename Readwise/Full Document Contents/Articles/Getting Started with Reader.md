...
- Category: #articles
- Summary: Reader is a keyboard-first app for reading, highlighting, and annotating.  
It supports articles, PDFs, EPUBs, YouTube, and includes a browser highlighter plus mobile apps with text-to-speech.  
Content lives in Library or Feed, and Reader is in public beta with frequent updates and in-app feedback.
