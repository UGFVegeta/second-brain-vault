...
Die organisatorische Seite zum Schulstart. Wie die Klasse reinkommt, wie eine Stunde beginnt und endet, wie Übergänge laufen, wie das Konzentrationssignal geht. Gehört inhaltlich zu [[Lernen lernen – Konzept Schulstart Klasse 7]], ist aber ein eigener Strang.

Quellen: Tom Bennett (*Running the Room*, *Creating a Culture*), Doug Lemov (*Teach Like a Champion*), aufbereitet aus Emily Horbach, *Classroom Management 101*.

## Prinzip

**Don't tell them, teach them.** Wenn ein Kind nicht weiß, wie es sich verhalten soll, ist das kein Fehlverhalten, sondern eine Lücke. Verhalten wird eingeübt wie Autofahren, nicht einmal erklärt und dann vorausgesetzt.

Weg zu jeder Routine: **erklären → vormachen → üben → beibehalten.** Der Aufwand liegt vorne. Die ersten zwei Wochen kosten Zeit, danach spart die Routine jeden Tag Zeit.

Regeln nicht als meine Regeln verkaufen, sondern als gemeinsame Vereinbarung mit einem Zweck: ein Raum, in dem jeder in Ruhe lernen und Fehler machen kann. Ich halte mich an dieselben Regeln (Pünktlichkeit, ausreden lassen).
...
Eindeutiges Zeichen, dass ein Kind fertig ist, ohne zu rufen: Arbeitsheft leicht aufgestellt, oder farbige Kärtchen (grün fertig, gelb Frage, rot Hilfe). Dazu vorher klären, was man tut, wenn man fertig ist (feste Zusatzaufgabe oder Weiterüben), damit kein Leerlauf entsteht.

### 6. Material austeilen

- Aufstellmethode: Stapel liegt vorne, Kinder holen sich der Reihe nach ein Blatt und gehen zurück. Gibt nebenbei eine kurze Bewegungspause.
- Oder Weitergabemethode: ein Blatt nehmen, Stapel zügig weiterreichen, kein Quatschen dabei. Einmal ohne Wettbewerb einüben, später darf es eine Challenge werden.
...
- Aufräum-Routine 3-2-1:
  ...
  - 1: auf mein Nicken verlässt Reihe für Reihe den Raum
...
- Handygarage oder Kiste auf dem Pult, Handy rein beim Reinkommen, als feste Routine. Nicht auf Fehlverhalten warten und dann einzeln ermahnen, sondern die Bedingung von vornherein schaffen.

## Einführung in den ersten zwei Wochen
...
- Bennett, T. (2022): *Running the Room*
- Lemov, D. (2015): *Teach Like a Champion 2.0* (SLANT, Cold Call, Exit Ticket)
- Glover (1989): Testeffekt
- Oakley u.a. (2021): *Uncommon Sense Teaching* (Bewegungspause beim Austeilen, Arbeitsgedächtnis)
- Emily Horbach: *Classroom Management 101* (gekauftes Material, Aufbereitung der obigen Quellen)
